...
# ════════════════════════════════════════════════════════════
    ...
    if not perfiles:
        ...
        <div class="card" style="text-align:center; padding:40px;">
            ...
            <p style="font-weight:700; color:#475569; font-size:1.5rem;">El panel está vacío</p>
            <p style="color:#94a3b8; font-size:1rem; margin-bottom:20px;">Para tu demostración, puedes generar perfiles de prueba con historiales completos.</p>
        </div>
        """, unsafe_allow_html=True)
        
        # ── BOTÓN DEMO AL CENTRO DE LA PANTALLA ──
